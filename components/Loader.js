...
// Function to shuffle the loading messages array
...
const Loader = () => {
    ...
    useEffect(() => {
        // Shuffle the messages array initially
        const shuffledMessages = shuffleArray(loadingMessages);

        // Set the first message from the shuffled array
        setCurrentMessage(shuffledMessages[index]);
