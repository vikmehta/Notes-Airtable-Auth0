            ...
            {colors.map((item, index) => {
                return (
                    <div
                        ...
                        className={`flex justify-center items-center shadow-sm shadow-slate-500 hover:shadow-slate-900 mr-3 mb-2 lg:mb-0 w-16 lg:w-20 h-9 cursor-pointer bg-${item} ${selectedColor === item ? 'selectedColor' : ''}`}
                    >
